...
⚠️ **For some reason, OpenCL doesn't seem to work with Docker on Bologna at the moment. Hopefully, this will be fixed in the future. In the meanwhile you can still use OpenCL without Docker on Bologna.**